					...
					<form>
						...
						<fieldset class="row mb-3">
							...
							<div class="col-sm-9">
								...
								<div class="form-check">
									<input ng-model="lpp.extrMethod.cdId" class="form-check-input" type="radio" name="extrMethod" id="extrMethod2" value="CD0102" disabled>
						...
						<div class="row mb-3">
							<label for="dbName" class="col-sm-3 col-form-label">데이터베이스 이름</label>
							<div class="col-sm-9">
						...
						<div class="row mb-3" ng-repeat="x in lpp.regex">
							<label for="tableName" class="col-sm-3 col-form-label">정규식{{$index+1}}</label>
							<div class="col-sm-9">
						...
						<hr>
						<a class='btn btn-outline-primary float-end mb-3' href='${pageContext.request.contextPath }/'	ng-click=''><span aria-hidden='true'>취소</span></a>
						<button type="submit" class='btn btn-outline-primary float-end mb-3'>등록</button>
					</form>
				</div>
			</div>
		</main>
